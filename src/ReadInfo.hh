...
class ReadInfo_t {
 public:
  ReadInfo_t(const int label, const string& set, const string& readname,
             const string& seq, const string& qv, char code, unsigned int strnd,
             unsigned int mate_order)
      : label_m(label),
        set_m(set),
        readname_m(readname),
        seq_m(seq),
  ...
  ReadId_t mateid_m;
  unsigned short
      mate_order_m;  // is first or second mate? (1=first, 2=mate, 0=unmated)
  Mer_t contigid_m;
